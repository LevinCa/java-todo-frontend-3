...
export const RequestFunctions = createContext<{getById: (id: string) => void ,change: (mode: string, id?: string, todo?: Todo) => void, post: (description: string) => void, progress: (todo: Todo) => void, put: (todo: Todo) => void, delete: (todo: Todo) => void, allTodos: Todo[], currentTodo: Todo, mode: string}>({getById: () => {}, change: () => {}, post: () => {}, progress: () => {}, put: () => {}, delete: () => {}, mode: "", currentTodo: {id: "", description: "", status: ""}, allTodos: []})
...
export default function ContextTodo(props: {children: ReactElement}) {
    ...
    return (
        <RequestFunctions.Provider value={{getById: getTodoById,allTodos: todos, currentTodo: currentTodo, mode: mode, post: postTodo, progress: progressTodo, put: putTodo, delete: deleteTodo, change: changeMode}}>
            {props.children}
